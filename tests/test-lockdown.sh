...
mkdir -p ${FLATPAK_LOCKDOWN_TEST_CONFIG_DIR}/remotes.d
...
cat << 'EOF' > ${FLATPAK_LOCKDOWN_TEST_CONFIG_DIR}/remotes.d/locked.flatpakrepo
[Flatpak Repo]
...
FLATPAK_CONFIG_DIR=/tmp/ignored-by-lockdown ${FLATPAK} --user remotes > remotes 2> warnings
assert_file_has_content remotes "locked"
